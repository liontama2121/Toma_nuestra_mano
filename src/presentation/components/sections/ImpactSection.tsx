    ...
    <section id="impacto" className="relative py-24">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <p className="text-[#FFC107] text-sm font-bold tracking-widest uppercase mb-3 ">Nuestro Impacto</p>
          <h2 className="font-black text-3xl sm:text-4xl lg:text-5xl text-white">
            Números que
